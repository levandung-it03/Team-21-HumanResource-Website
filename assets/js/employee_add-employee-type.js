...
(function main() {
    const errorMessages = {
        employee_type: {
            ...
            message: "Tên của loại nhân viên không hợp lệ.",
            isValid: false,
        },
        multipleSalary: {
            confirm: function (value) {
    ...
    if (myParam) {
        alert('Loại nhân viên này đã tồn tại!');
        (async function handleRedirect() {
            ...
            window.history.replaceState({}, "", "http://localhost:3000/admin/category/employee/add-employee-type");
