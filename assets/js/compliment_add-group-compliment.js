...
(function main() {
    ...
    if (myParam) {
        alert('Đội nhóm này không được khen thưởng một loại hình quá nhiều trong cùng một thời gian quyết định!');
        (async function handleRedirect() {
            ...
            window.history.replaceState({}, "", "http://localhost:3000/admin/category/compliment/add-group-compliment");
