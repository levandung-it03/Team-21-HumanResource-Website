...
(function main() {
    ...
    if (myParam) {
        alert('Nhân viên này không được kỷ luật một loại hình quá nhiều trong cùng một thời gian quyết định!');
        (async function handleRedirect() {
            ...
            window.history.replaceState({}, "", "http://localhost:3000/admin/category/discipline/add-employee-discipline");
